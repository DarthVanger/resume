...
\section{Brief Summary}
  ...
  I challenge decicions and status quo when I see a good reason to do so.

\section{Experience Summary}
  \begin{itemize}
    \item 2 years React + TypeScript, Redux \\
...
\section{My projects}
  \begin{itemize}
    \item NeuralNotes - web app to keep notes and files as a mind map: \url{https://github.com/DarthVanger/NeuralNotes} \\
...
\section{Experience in detail}
  ...
  Working with frontend and backend, participating in technical discoveries for upcoming features, code reviews, security code reviews.
    ...
    \end{itemize}
  \subsection{2018-2019: One of the biggest UK online grocery retailers. React UI library based on Bootstrap 4}
...
\section{Personal Info}
	Age: 30 years \\
  Residence: Kyiv, Ukraine (relocation possible)
